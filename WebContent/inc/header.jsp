<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <c:set var="ctxName" value="${pageContext.request.servletContext.servletPath}"></c:set>
	<header id="header">
            ...
            <section class="header-item-container">
                ...
                <nav id="my-menu">
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="my-menu-item"><a class="my-menu-item-text" href="customer/notice.jsp"><img src="images/txt-customer.png" alt="고객센터" /></a></li>
                    </ul>
                </nav>
            </section>
        </div>
